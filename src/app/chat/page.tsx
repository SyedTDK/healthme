              ...
              <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                {ChatSessions?.map((session: any, index: number) => (
                  ...
                  >
                    ...
                    <p className="font-normal text-gray-400">Symptoms experianced: {session.symptoms?.join(', ')}</p>
                    <p className="font-normal text-gray-400">Possible Diagnosis by AI: {session.diagnosis}</p>
                  </div>
                ))}
